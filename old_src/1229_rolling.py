...
def rolling_total(x_torch,length,dtype):
    ...
    rolling_2 = ((lossy_result >= 128) & (lossy_result < 256))  # 0000 0000 1000 0000
    rolling_3 = ((lossy_result >= 256) & (lossy_result < 512))  # 0000 0001 0000 0000
...
for name, param in tqdm(model.named_parameters()):
    ...
    with torch.no_grad():
        ...
        param_index = rolling_total(Quant_input, length, dtype)
        ...
        param_comp_index = rolling_total(Comp_output.to('cuda'), length, dtype)
